...
if args.rolling_mean:
    output_df.to_csv(f"/data/math-hpc-machine-learning/univ5366/output/simulation_n_neurons_{args.n_neurons}_max_time_{args.max_time}_n_paths_{args.n_paths}_rolling_mean")
else:
    output_df.to_csv(f"/data/math-hpc-machine-learning/univ5366/output/simulation_n_neurons_{args.n_neurons}_max_time_{args.max_time}_{args.n_paths}_actual")
